"""
1. 确保正确安装PyQt5
首先，确保你已经正确安装了PyQt6。在命令行中运行以下命令来安装PyQt5：pip install PyQt5

2. 安装Visual C++ Redistributable
PyQt5依赖于Visual C++ Redistributable。如果没有安装，可能会导致DLL加载失败。
